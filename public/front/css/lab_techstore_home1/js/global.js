...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html += '<div class="left-block col-xs-3 col-sm-5 col-md-3">' + $(element).find('.left-block').html() + '</div>';
			html += '<div class="center-block col-xs-9 col-sm-7 col-md-9">';
				...
				html += '<div class="media-body">';
					...
					html += '<div class="lab-quick-view pull-right">' + $(element).find('.lab-quick-view').html() + '</div>';
				html += '</div>';
